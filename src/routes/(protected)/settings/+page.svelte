<script lang="ts">
  ...
  let currentSection = $state<
    "profile" | "accessibility" | "security" | "terms" | "notifications"
  >("profile");
  ...
  let modes = $state<"Do Not Disturb" | "Silent" | "Allow All">(
    "Do Not Disturb",
  );
  ...
  onMount(() => {
    ...
    modes =
      (localStorage.getItem("notificationMode") as
        | "Do Not Disturb"
        | "Silent"
        | "Allow All") || "Do Not Disturb";
    themeBtn = $theme;
  ...
  function handleTextClick(event: MouseEvent) {
    ...
    if (
      target.matches("p, h1, h2, h3, h4, h5, h6, label, button, a, span, li")
    ) {
...
<div class="relative min-h-screen">
  <div
    class="md:hidden px-4 py-3 mb-6 border-b border-gray-700"
  ...
  >
    ...
    <button
      ...
      class="w-full mt-2 py-2 rounded-lg text-red-400 border !border-red-800 text-sm !bg-transparent"
    >
      Logout
    </button>
  </div>
  <div class="hidden md:block">
    <Sidebar
      ...
      class="z-50 absolute left-0 top-0 bottom-0 w-64 dark:bg-[#17191C]!"
      position="absolute"
    ...
    >
      <SidebarGroup>
        <SidebarItem
          label="Profile"
          onclick={() => (currentSection = "profile")}
        ...
        <SidebarItem
          label="Notifications"
          onclick={() => (currentSection = "notifications")}
          class="cursor-pointer"
        >
          {#snippet icon()}
        ...
        <SidebarItem
          label="Accesibility"
          onclick={() => (currentSection = "accessibility")}
          class="cursor-pointer"
        >
          {#snippet icon()}
        ...
        <SidebarItem
          ...
          onclick={() => (currentSection = "security")}
          class="cursor-pointer"
        >
          {#snippet icon()}
    ...
    >
      {#if currentSection === "profile"}
        <div class="flex flex-col mt-6">
          ...
          {:else}
            <div
              class="w-20 h-20 rounded-full bg-gray-700 flex items-center justify-center mb-3"
            >
        ...
        <form method="POST" action="?/updateProfile">
          <div class="mb-6 grid gap-4">
            ...
            <div class="flex flex-col">
              <Label for="profile_description" class="mb-2"
    ...
    {statusText.length}/50
      ...
      {#if currentSection === "accessibility"}
        <div class="space-y-6">
          ...
          <div>
            ...
            <div class="space-y-2">
              <Label
                class="flex items-center space-x-3 cursor-pointer p-3 dark:hover:bg-[#222326] rounded"
              >
                <input
                  type="radio"
                  bind:group={fontSize}
          ...
          <div>
            ...
            <p class="text-gray-600 mb-4">
              Enhanced visual indicators when navigating with keyboard
            </p>
            <div class="space-y-2">
              <Label
                class="flex items-center space-x-3 cursor-pointer p-3 dark:hover:bg-[#222326] rounded"
              ...
              <p class="text-sm text-gray-500 ml-7">
                Shows clear outlines around buttons and links when using Tab key
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <p class="text-sm text-gray-500 ml-7">
                Uses OpenDyslexic font with weighted bottoms to help prevent
                confusion
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <p class="text-sm text-gray-500 ml-7">
                Click on headings, paragraphs, or buttons to have them read
                aloud
              </p>
              {#if isReading}
                <p class="text-sm text-green-600 ml-7 font-semibold">
                  🔊 Reading...
                </p>
              {/if}
            </div>
      ...
      {#if currentSection === "security"}
        ...
        <div class="mb-6">
          ...
          <p class="text-gray-600 mb-3">
            Control whether your location is shared with friends.
          </p>
          <Toggle
        ...
        <p class="text-gray-600 mb-3">
          Control whether your name is shown when you submit an alert.
        </p>
        <Toggle
          ...
          onchange={async (e) => {
            ...
            formData.append(
              "location_sharing",
              (user.locationSharing ?? true) ? "on" : "off",
            );
            formData.append(
              "anonymous_alerts",
              e.target.checked ? "on" : "off",
      ...
      {#if currentSection === "terms"}
        <div class="space-y-6">
          ...
          <div
            class="overflow-y-auto max-h-96 space-y-4 pr-2 text-sm text-gray-600 dark:text-gray-400"
          >
            <div>
              ...
              <p>
                Beacon is a community emergency alert platform that enables
                users to send, receive, and respond to emergency alerts in real
                time. The platform is provided as-is, and no guarantees are made
                regarding uptime or response times during emergencies.
              </p>
            </div>
            <div>
              <h3 class="font-semibold text-gray-800 dark:text-white mb-1">
              ...
              <p>
                Beacon may collect and use your location data to deliver
                relevant alerts and notify nearby responders. You consent to the
                collection and processing of your location information during
                active alert events. You may disable location sharing at any
            ...
            <div>
              ...
              <p>
                You consent to receiving push notifications, SMS, or email
                alerts for emergency events in your registered area.
                Notification delivery is dependent on your device settings and
            ...
            <div>
              ...
              <p>
                In the event of a declared emergency, your alert activity and
                general location may be shared with local emergency services,
                law enforcement, or authorized first responders. Beacon does not
            ...
            <div>
              ...
              <p>
                Beacon does not guarantee platform availability at all times,
                particularly during large-scale emergencies. Do not rely solely
                on Beacon as your only emergency communication method.
              </p>
            </div>
            <div>
              <h3 class="font-semibold text-gray-800 dark:text-white mb-1">
              ...
              <p>
                You agree not to submit false, misleading, or malicious alerts.
                Misuse of the platform may result in account suspension and may
            ...
            <div>
              ...
              <p>
                Beacon reserves the right to update these terms at any time. You
                will be notified of significant changes and may be asked to
          ...
          <p class="text-sm text-gray-500">
            You accepted these terms on <span class="font-medium"
        ...
        <div class="space-y-6">
          ...
          >
            <input
              ...
              onchange={applyNotificationMode}
              class="w-4 h-4"
            />
